        ...
        <div className="flex flex-col lg:flex-row h-[calc(100vh-4rem)]">
            <Disclosure defaultOpen>
                {({ open }) => (
                    ...
                    <Disclosure.Panel className={`overflow-y-auto order-3 lg:order-1 flex flex-col h-full lg:w-96 bg-[#2E3032]`}>
                        <ProgressInformation />
                    </Disclosure.Panel>
                    ...
                    {/* Embeded Twitch  */}
                    <div className="order-1 flex-10 lg:order-3 h-full w-full lg:h-[calc(100vh-4rem)]">
