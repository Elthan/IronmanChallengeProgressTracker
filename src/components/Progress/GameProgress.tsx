    ...
    return (
        <div key={progress.name} className="flex flex-row justify-center lg:justify-end lg:flex-col items-center">
            <article className="flex flex-col items-center">
                ...
                <img className={`mx-8 lg:mx-0 hover:animate-pulse h-10 w-10 ${mapProgressToIconStyle(progress.points || 0)}`} src={progress.nextIcon} alt={`${progress.nextRank} icon`}/>
            ...
            <article className="flex flex-col items-center mx-0">
