...
export default function GameProgress(progress: IGameProgress) {
    return (
        <div key={progress.name} className="flex flex-row justify-end lg:flex-col items-center lg:justify-between group">
            ...
            <div className="flex flex-row-reverse lg:flex-col-reverse min-w-[200px] h-6 w-2/4 lg:h-full lg:w-9 lg:min-w-fit lg:min-h-[200px] rounded-sm border-[1px] border-primary-600 overflow-hidden group-hover:border-primary-50">
