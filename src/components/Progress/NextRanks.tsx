...
function NextRanks({ gameInfo }: GameInfoArray) {
  return (
    // <div className="order-2 h-full flex flex-col py-5">   
      <Disclosure as="div" defaultOpen className="order-2 h-full flex flex-col py-5">
        {({ open }) => (
          <>
          ...
          <Disclosure.Panel className="h-full w-full flex flex-col lg:flex-row justify-around">
